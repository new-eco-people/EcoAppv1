...
@Component({
    selector: 'app-private-full-layout',
    templateUrl: './private-full-layout.component.html',
    styleUrls: ['./private-full-layout.component.scss']
})

export class PrivateFullLayoutComponent implements OnInit, AfterViewInit {
